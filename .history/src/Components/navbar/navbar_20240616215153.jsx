...
import CustomThemeToggle from "./theme";
      ...
      <div className="mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-5">
            <CustomThemeToggle />
            <button className="hidden md:block border-2 border-custom_border_color font-bold rounded-full px-4 py-2  text-custom_contact_button">
              Contact us
            </button>
          </div>
