    ...
    <section className="bg-gray-100 py-20 flex flex-col justify-center items-center w-screen h-screen">
      <div className="max-w-screen-lg mx-auto px-4 flex flex-col justify-center items-center">
        ...
        <div className="flex gap-5 justify-center mt-20">
          {/* btn 1 */}
          <button className="bg-accent border-2  border-black font-semibold text-sm md:text-md px-7 py-2 rounded-full hover:bg-white">
            Get Started
          </button>

          {/* btn 2 */}
          <button className="flex items-center gap-2 px-4 py-2 font-semibold text-sm md:text-md  ml-4">
