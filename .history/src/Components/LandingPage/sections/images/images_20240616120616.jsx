...
export default function ImagesSection() {
  ...
  return (
    <div className="flex gap-5 p-9 bg-gray-100 overflow-x-auto overflow-y-hidden h-[30rem]">
      <div className="relative flex flex-1 flex-col min-w-[40rem]  h-full  text-white rounded-3xl overflow-hidden">
        <img
          src={images[0].src}
          alt="a_photo"
      ...
      <div className="grid grid-rows-2 grid-flow-col gap-3">
        {images.slice(1).map((image, index) => (
          <div
            key={index}
            className="relative flex flex-col w-96 h-40 bg-gray-300 rounded-3xl overflow-hidden"
          >
            <img
              src={image.src}
              alt="a_photo"
