...
export default function ImagesSection() {
  ...
  return (
    <div className="flex gap-5 p-9  overflow-x-auto overflow-y-hidden h-[23rem]  md:h-[30rem] ">
      <div className="relative flex flex-1 flex-col min-w-[23rem]  md:min-w-[40rem]  h-full  rounded-3xl overflow-hidden">
        ...
        <div className="absolute bottom-0 text-start text-white flex flex-col justify-center items-start px-14 py-2  ">
          <h2 className="text-2xl font-semibold">{images[0].title}</h2>
