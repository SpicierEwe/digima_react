...
export default function ImagesSection() {
  ...
  return (
    <div className="flex gap-5 p-9 bg-gray-100 overflow-x-auto overflow-y-hidden h-[25rem]">
      <div className="relative flex flex-1 flex-col min-w-[35rem]  h-full  text-white rounded-lg overflow-hidden">
        <img
          src={images[0].src}
          alt="a_photo"
