...
export default function ImagesSection() {
  ...
  return (
    <div className="flex gap-5 p-9 bg-gray-100 overflow-x-scroll overflow-y-hidden">
      <div
        className="relative flex flex-1 flex-col   h-full bg-gray-700 text-white p-8 rounded-lg"
        style={{
