...
export default function HeroSection() {
  return (
    <section className="flex flex-col md:justify-center">
      <div className="max-w-screen-lg mx-auto px-4 flex flex-col justify-center items-start md:items-center h-screen md:h-[45rem] pt-5 md:pt-0">
        {/* subtitle */}
        ...
        {/*  hero title */}
        <h1 className="text-5xl text-left md:text-center leading-tight md:leading-tight font-bold   mt-4.5 md:mt-7">
