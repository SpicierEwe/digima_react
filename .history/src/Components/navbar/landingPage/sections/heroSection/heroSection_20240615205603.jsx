  ...
  return (
    <section className="bg-gray-100 py-20 flex flex-col justify-center items-center w-screen h-screen">
      <div className="max-w-screen-lg mx-auto px-4 flex flex-col justify-center items-center">
        <h2 className="text-sm  md:text-md font-semibold  text-center mb-6 tracking-wider md:tracking-[.65em] bg-accent rounded-full p-3 md:p-1 px-5 md:px-20 w-fit ">
          DIGITAL MARKETING
        </h2>
        <h1 className="text-3xl md:text-6xl leading-tight font-bold text-center mt-5">
