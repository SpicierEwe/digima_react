  ...
  return (
    <div className="flex flex-col  md:flex-row p-5 gap-5 my-14 md:my-16">
      {dataArray.map((item, index) => (
        <div
          key={index}
          className={` flex flex-col md:flex-row rounded-lg overflow-hidden shadow-lg mx-5 px-3 py-7`}
        >
          {/* image */}
          <img
            src={item.image}
            alt=""
            className="h-40 aspect-square shrink-0 object-cover rounded-xl md:h-full"
          />
