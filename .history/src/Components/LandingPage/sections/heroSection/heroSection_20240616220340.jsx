...
export default function HeroSection() {
  return (
    <section className="flex flex-col md:justify-center">
      <div className="max-w-screen-lg mx-auto px-4 flex flex-col justify-center items-start text-start md:text-center min-h-screen">
        {/* subtitle */}
        ...
        {/*  hero title */}
        <h1 className="text-center leading-tight md:leading-tight font-bold   mt-4.5 md:mt-7">
