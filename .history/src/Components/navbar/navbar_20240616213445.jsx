    ...
    <header className="max-w-screen-xl mx-auto">
      <div className="mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          ...
          <button className="hidden md:block border-2 border-custom_border_color font-bold rounded-full px-4 py-2 ">
            <p className="text-custom_contact_button "> Contact us</p>
          </button>
