...
export default function Faq() {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-evenly p-5 md:px-20  gap-5 gap-y-14 gap-x-52 ">
        ...
        {data.map((item, index) => {
          return (
            <li key={index} className="py-2 border-b-2 border-black pb-7">
              ...
              >
                {/* question */}
                <div className="flex items-center justify-between cursor-pointer hover:bg-secondary p-3">
