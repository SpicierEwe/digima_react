...
export default function ImagesSection() {
  ...
  return (
    <div className="flex gap-5 p-9 bg-gray-100">
      <div className="relative flex flex-col w-2/3 bg-gray-700 text-white p-8 rounded-lg">
      ...
      <div className="grid grid-cols-1 frid-cols-4 gap-3 w-1/3">
        {images.slice(1).map((image, index) => (
          <div
            key={index}
            className="relative flex flex-col bg-gray-300 rounded-lg overflow-hidden"
          >
            <img
              src={image.src}
              alt="a_photo"
