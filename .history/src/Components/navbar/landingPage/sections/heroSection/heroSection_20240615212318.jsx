  ...
  return (
    <section className="bg-gray-100 py-20 flex flex-col justify-center items-center w-screen h-screen">
      <div className="max-w-screen-lg mx-auto px-4 flex flex-col justify-center items-center">
        {/* subtitle */}
        <h2 className="text-xs  md:text-md font-semibold  text-center mb-6 tracking-[.5em] md:tracking-[.65em] bg-accent rounded-full p-2 md:p-2.5 px-5 md:px-20 w-fit ">
          DIGITAL MARKETING
        </h2>

        {/*  hero title */}
        <h1 className="text-3xl md:text-7xl leading-tight font-bold text-center mt-4.5 md:mt-7">
