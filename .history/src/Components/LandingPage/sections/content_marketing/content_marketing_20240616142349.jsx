  ...
  return (
    <div className="flex flex-col  md:flex-row p-5 gap-5 my-14 md:my-16">
      {dataArray.map((item, index) => (
        <div
          key={index}
          className={`mb-4 flex flex-col rounded-lg overflow-hidden shadow-lg mx-5 px-3 py-7`}
        >
          {/* image */}
          <img
            src={item.image}
          ...
          <div className="p-5 text-start">
            ...
            <div className="flex justify-between">
              ...
              <button className="w-fit h-fit border-2 border-black py-0 px-4 bg-secondary text-black font-semibold text-xs rounded-full">
                Category
              </button>
            </div>
            ...
            <button className="mt-5 border-2 border-black px-7 py-2 bg-accent text-black font-semibold text-xs rounded-full">
              Read More
            </button>
          </div>
        </div>
