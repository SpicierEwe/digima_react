...
export default function ImagesSection() {
  ...
  return (
    <div className="flex gap-5 p-9  overflow-x-auto overflow-y-hidden h-[25rem]  md:h-[30rem] ">
      <div className="relative flex flex-1 flex-col min-w-[25rem]  md:min-w-[40rem]  h-full  rounded-3xl overflow-hidden">
        <img
          src={images[0].src}
          alt="a_photo"
        ...
        <div className="absolute">
          ...
          <div className="inset-0 bottom-0 h-full">
