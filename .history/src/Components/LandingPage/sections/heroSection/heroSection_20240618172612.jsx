...
export default function HeroSection() {
  return (
    <section className="flex flex-col md:justify-center mt-10 md:mt-0">
      <div className="max-w-screen-lg mx-auto px-4 flex flex-col justify-center items-start md:items-center h-screen md:h-[45rem] pt-10 md:pt-0">
        ...
        {/*  hero title */}
        <h1 className="text-3xl text-left md:text-center leading-tight md:leading-tight font-bold   mt-4.5 md:mt-7">
