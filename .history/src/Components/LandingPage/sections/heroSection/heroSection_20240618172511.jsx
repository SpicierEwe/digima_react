  ...
  return (
    <section className="flex flex-col md:justify-center">
      <div className="max-w-screen-lg mx-auto px-4 flex flex-col justify-center items-start md:items-center h-screen md:h-[45rem] pt-10 md:pt-0">
        {/* subtitle */}
        <h4 className="mt-10 text-sm  md:text-lg font-semibold  text-center mb-6 tracking-[.5em] md:tracking-[.5em] bg-accent rounded-full p-2 md:p-2.5 px-5 md:px-20 w-fit text-black">
          DIGITAL MARKETING
        </h4>
