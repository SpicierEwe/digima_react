  ...
  return (
    ...
    >
      ...
      <div className="p-3 text-start">
        ...
        {/* description */}
        <p className="md:text-md font-medium text-sm   text-gray-600 mt-7 ">
          {item.description}
        </p>

        <button className="mt-9 md:mt-14 md:mt-5 border-2 border-black px-7 py-2 bg-accent text-black font-semibold text-xs rounded-full">
          Read More
        </button>
      </div>
    </div>
